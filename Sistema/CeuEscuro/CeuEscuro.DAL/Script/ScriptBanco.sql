...
SELECT IdUsuario, NomeUsuario, CpfUsuario, SenhaUsuario, DataNascUsuario, UrlImgUsuario, DescricaoTipoUsuario FROM Usuario Join TipoUsuario ON TipoUsuario=IdTipoUsuario;